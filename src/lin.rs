...
mod tests {
    use super::*;
    use crate::rational::{Rational, r, rat};
    use std::collections::HashMap;

    #[test]
    fn test_new_and_display() {
        let lin = Lin::new(HashMap::from([(VarId(1), rat(1, 2)), (VarId(2), rat(-3, 4))]), r(5));
    ...
    #[test]
    fn test_add_lin() {
        let lin1 = Lin::new(HashMap::from([(VarId(1), r(1))]), r(2));
        let lin2 = Lin::new(HashMap::from([(VarId(1), r(2)), (VarId(2), r(3))]), r(4));

        let sum = lin1 + lin2;

        let expected = Lin::new(HashMap::from([(VarId(1), r(3)), (VarId(2), r(3))]), r(6));
    ...
    fn test_add_rational() {
        let lin = Lin::new(HashMap::from([(VarId(1), r(1))]), r(2));
        let sum = lin + r(3);
        let expected = Lin::new(HashMap::from([(VarId(1), r(1))]), r(5));
    ...
    fn test_sub_lin() {
        ...
        let expected = Lin::new(HashMap::from([(VarId(1), r(-1)), (VarId(2), r(-3))]), r(-2));
    ...
    fn test_sub_rational() {
        let lin = Lin::new(HashMap::from([(VarId(1), r(1))]), r(2));
        let diff = lin - r(3);
        let expected = Lin::new(HashMap::from([(VarId(1), r(1))]), r(-1));
    ...
    fn test_mul_rational() {
        let lin = Lin::new(HashMap::from([(VarId(1), rat(1, 2))]), rat(3, 4));
        let product = lin * r(2);
        let expected = Lin::new(HashMap::from([(VarId(1), r(1))]), rat(3, 2));
    ...
    fn test_div_rational() {
        let lin = Lin::new(HashMap::from([(VarId(1), r(1))]), rat(3, 2));
        let quotient = lin / r(2);
        let expected = Lin::new(HashMap::from([(VarId(1), rat(1, 2))]), rat(3, 4));
    ...
    fn test_substitute() {
        // 2*x1 + 3*x2 + 5
        let mut lin1 = Lin::new(HashMap::from([(VarId(1), r(2)), (VarId(2), r(3))]), r(5));
        // substitute x1 with (4*x3 + 1)
        let lin_sub = Lin::new(HashMap::from([(VarId(3), r(4))]), r(1));
        lin1.substitute(VarId(1), &lin_sub);
        // expected = 3*x2 + 8*x3 + 7
        let expected = Lin::new(HashMap::from([(VarId(2), r(3)), (VarId(3), r(8))]), r(7));
    ...
    fn test_substitute_combine() {
        // 2*x1 + 3*x2
        let mut lin1 = Lin::new(HashMap::from([(VarId(1), r(2)), (VarId(2), r(3))]), r(0));
        // substitute x1 with (x2 + 1)
        let lin_sub = Lin::new(HashMap::from([(VarId(2), r(1))]), r(1));
        lin1.substitute(VarId(1), &lin_sub);
        // expected = 5*x2 + 2
        let expected = Lin::new(HashMap::from([(VarId(2), r(5))]), r(2));
    ...
    fn test_substitute_merge_and_cancel() {
        // Original: 1x + 2y + 0
        let mut expr = Lin::new(HashMap::from([(VarId(1), r(1)), (VarId(2), r(2))]), r(0));

        // Substitution: x = -2y + 10
        let sub = Lin::new(HashMap::from([(VarId(2), r(-2))]), r(10));
        ...
        assert_eq!(expr.known_term, r(10));
    }

    #[test]
    #[should_panic]
    fn test_substitute_missing_var() {
        let mut lin = Lin::new(HashMap::from([(VarId(1), r(1))]), r(0));
    ...
    fn test_add_lin_variations() {
        let lin1 = Lin::new(HashMap::from([(VarId(1), r(1))]), r(2));
        let lin2 = Lin::new(HashMap::from([(VarId(2), r(3))]), r(4));

        // Test Lin + Lin
        let res1 = lin1.clone() + lin2.clone();
        assert_eq!(res1.vars.get(&VarId(1)), Some(&r(1)));
        assert_eq!(res1.vars.get(&VarId(2)), Some(&r(3)));
        assert_eq!(res1.known_term, r(6));

        // Test &Lin + Lin
        let res2 = &lin1 + lin2.clone();
        assert_eq!(res2.known_term, r(6));

        // Test Lin + &Lin
        let res3 = lin1.clone() + &lin2;
        assert_eq!(res3.known_term, r(6));

        // Test &Lin + &Lin
        let res4 = &lin1 + &lin2;
        assert_eq!(res4.known_term, r(6));
    }
    ...
    fn test_add_rational_variations() {
        ...
        assert_eq!(res1.known_term, r(5));

        // Test &Lin + Rational
        let res2 = &lin + rat_val;
        assert_eq!(res2.known_term, r(5));

        // Test Lin + &Rational
        let res3 = lin.clone() + &rat_val;
        assert_eq!(res3.known_term, r(5));

        // Test &Lin + &Rational
        let res4 = &lin + &rat_val;
        assert_eq!(res4.known_term, r(5));

        // Test Rational + Lin
        let res5 = rat_val + lin.clone();
        assert_eq!(res5.known_term, r(5));

        // Test Rational + &Lin
        let res6 = rat_val + &lin;
        assert_eq!(res6.known_term, r(5));

        // Test &Rational + Lin
        let res7 = &rat_val + lin.clone();
        assert_eq!(res7.known_term, r(5));

        // Test &Rational + &Lin
        let res8 = &rat_val + &lin;
        assert_eq!(res8.known_term, r(5));
    }

    #[test]
    fn test_sub_lin_variations() {
        let lin1 = Lin::new(HashMap::from([(VarId(1), r(5))]), r(10));
        let lin2 = Lin::new(HashMap::from([(VarId(1), r(2))]), r(3));

        // Test Lin - Lin
        let res1 = lin1.clone() - lin2.clone();
        assert_eq!(res1.vars.get(&VarId(1)), Some(&r(3)));
        assert_eq!(res1.known_term, r(7));

        // Test &Lin - Lin
        let res2 = &lin1 - lin2.clone();
        assert_eq!(res2.known_term, r(7));

        // Test Lin - &Lin
        let res3 = lin1.clone() - &lin2;
        assert_eq!(res3.known_term, r(7));

        // Test &Lin - &Lin
        let res4 = &lin1 - &lin2;
        assert_eq!(res4.known_term, r(7));
    }

    #[test]
    fn test_sub_rational_variations() {
        let lin = Lin::new(HashMap::from([(VarId(1), r(1))]), r(10));
        let rat_val = r(3);
        ...
        let res5 = rat_val - lin.clone();
        assert_eq!(res5.vars.get(&VarId(1)), Some(&r(-1)));
        assert_eq!(res5.known_term, r(-7));

        // Test Rational - &Lin
        let res6 = rat_val - &lin;
        assert_eq!(res6.vars.get(&VarId(1)), Some(&r(-1)));
        assert_eq!(res6.known_term, r(-7));

        // Test &Rational - Lin
        let res7 = &rat_val - lin.clone();
        assert_eq!(res7.vars.get(&VarId(1)), Some(&r(-1)));
        assert_eq!(res7.known_term, r(-7));

        // Test &Rational - &Lin
        let res8 = &rat_val - &lin;
        assert_eq!(res8.vars.get(&VarId(1)), Some(&r(-1)));
        assert_eq!(res8.known_term, r(-7));
    }

    #[test]
    fn test_mul_rational_variations() {
        let lin = Lin::new(HashMap::from([(VarId(1), r(2))]), r(3));
        let rat_val = r(4);

        // Test Lin * Rational
        let res1 = lin.clone() * rat_val;
        assert_eq!(res1.vars.get(&VarId(1)), Some(&r(8)));
        assert_eq!(res1.known_term, r(12));

        // Test &Lin * Rational
        let res2 = &lin * rat_val;
        assert_eq!(res2.known_term, r(12));

        // Test Lin * &Rational
        let res3 = lin.clone() * &rat_val;
        assert_eq!(res3.known_term, r(12));

        // Test &Lin * &Rational
        let res4 = &lin * &rat_val;
        assert_eq!(res4.known_term, r(12));
    }

    #[test]
    fn test_div_rational_variations() {
        let lin = Lin::new(HashMap::from([(VarId(1), r(8))]), r(12));
        let rat_val = r(4);

        // Test Lin / Rational
        let res1 = lin.clone() / rat_val;
        assert_eq!(res1.vars.get(&VarId(1)), Some(&r(2)));
        assert_eq!(res1.known_term, r(3));

        // Test &Lin / Rational
        let res2 = &lin / rat_val;
        assert_eq!(res2.known_term, r(3));

        // Test Lin / &Rational
        let res3 = lin.clone() / &rat_val;
        assert_eq!(res3.known_term, r(3));

        // Test &Lin / &Rational
        let res4 = &lin / &rat_val;
        assert_eq!(res4.known_term, r(3));
    }

    #[test]
    fn test_add_assign_variations() {
        // Test AddAssign<Lin>
        let mut lin1 = Lin::new(HashMap::from([(VarId(1), r(1))]), r(2));
        lin1 += Lin::new(HashMap::from([(VarId(2), r(3))]), r(4));
        assert_eq!(lin1.known_term, r(6));

        // Test AddAssign<&Lin>
        let mut lin2 = Lin::new(HashMap::from([(VarId(1), r(1))]), r(2));
        lin2 += &Lin::new(HashMap::from([(VarId(2), r(3))]), r(4));
        assert_eq!(lin2.known_term, r(6));

        // Test AddAssign<Rational>
        let mut lin3 = Lin::new(HashMap::from([(VarId(1), r(1))]), r(2));
        lin3 += r(5);
        assert_eq!(lin3.known_term, r(7));

        // Test AddAssign<&Rational>
        let mut lin4 = Lin::new(HashMap::from([(VarId(1), r(1))]), r(2));
        lin4 += &r(5);
        assert_eq!(lin4.known_term, r(7));
    }

    #[test]
    fn test_sub_assign_variations() {
        // Test SubAssign<Lin>
        let mut lin1 = Lin::new(HashMap::from([(VarId(1), r(5))]), r(10));
        lin1 -= Lin::new(HashMap::from([(VarId(1), r(2))]), r(3));
        assert_eq!(lin1.vars.get(&VarId(1)), Some(&r(3)));
        assert_eq!(lin1.known_term, r(7));

        // Test SubAssign<&Lin>
        let mut lin2 = Lin::new(HashMap::from([(VarId(1), r(5))]), r(10));
        lin2 -= &Lin::new(HashMap::from([(VarId(1), r(2))]), r(3));
        assert_eq!(lin2.known_term, r(7));

        // Test SubAssign<Rational>
        let mut lin3 = Lin::new(HashMap::from([(VarId(1), r(1))]), r(10));
        lin3 -= r(3);
        assert_eq!(lin3.known_term, r(7));

        // Test SubAssign<&Rational>
        let mut lin4 = Lin::new(HashMap::from([(VarId(1), r(1))]), r(10));
        lin4 -= &r(3);
        assert_eq!(lin4.known_term, r(7));
    }
    ...
    fn test_mul_assign_variations() {
        ...
        let mut lin1 = Lin::new(HashMap::from([(VarId(1), r(2))]), r(3));
        lin1 *= r(4);
        assert_eq!(lin1.vars.get(&VarId(1)), Some(&r(8)));
        assert_eq!(lin1.known_term, r(12));

        // Test MulAssign<&Rational>
        let mut lin2 = Lin::new(HashMap::from([(VarId(1), r(2))]), r(3));
        lin2 *= &r(4);
        assert_eq!(lin2.known_term, r(12));
    }

    #[test]
    fn test_div_assign_variations() {
        // Test DivAssign<Rational>
        let mut lin1 = Lin::new(HashMap::from([(VarId(1), r(8))]), r(12));
        lin1 /= r(4);
        assert_eq!(lin1.vars.get(&VarId(1)), Some(&r(2)));
        assert_eq!(lin1.known_term, r(3));

        // Test DivAssign<&Rational>
        let mut lin2 = Lin::new(HashMap::from([(VarId(1), r(8))]), r(12));
        lin2 /= &r(4);
        assert_eq!(lin2.known_term, r(3));
    }
}
