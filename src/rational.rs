...
mod tests {
    ...
    fn test_reciprocal() {
        ...
        let inf = Rational::POSITIVE_INFINITY;
        assert_eq!(inf.reciprocal(), Rational::ZERO);
    }
    ...
    fn test_add_assign_with_ref_and_infinity() {
        ...
        // Test with matching infinities
        let mut e = Rational::POSITIVE_INFINITY;
        e += &Rational::POSITIVE_INFINITY;
        assert_eq!(e, Rational::POSITIVE_INFINITY);

        let mut f = Rational::NEGATIVE_INFINITY;
        f += &Rational::NEGATIVE_INFINITY;
        assert_eq!(f, Rational::NEGATIVE_INFINITY);
    }
    ...
    #[test]
    #[should_panic(expected = "Indeterminate form: infinity + (-infinity)")]
    fn test_add_assign_ref_inf_plus_neg_inf() {
        let mut a = Rational::POSITIVE_INFINITY;
    ...
    #[test]
    #[should_panic(expected = "Indeterminate form: infinity + (-infinity)")]
    fn test_add_assign_ref_neg_inf_plus_inf() {
        let mut a = Rational::NEGATIVE_INFINITY;
    ...
    fn test_sub_assign_with_ref_and_infinity() {
        ...
        // Test with different infinities (should work)
        let mut e = Rational::POSITIVE_INFINITY;
        e -= &Rational::NEGATIVE_INFINITY;
        assert_eq!(e, Rational::POSITIVE_INFINITY);

        let mut f = Rational::NEGATIVE_INFINITY;
        f -= &Rational::POSITIVE_INFINITY;
        assert_eq!(f, Rational::NEGATIVE_INFINITY);
    }
    ...
    #[test]
    #[should_panic(expected = "Indeterminate form: infinity - infinity")]
    fn test_sub_assign_ref_inf_minus_inf() {
        let mut a = Rational::POSITIVE_INFINITY;
        a -= &Rational::POSITIVE_INFINITY;
    }
    ...
    #[test]
    #[should_panic(expected = "Indeterminate form: infinity - infinity")]
    fn test_sub_assign_ref_neg_inf_minus_neg_inf() {
        let mut a = Rational::NEGATIVE_INFINITY;
        a -= &Rational::NEGATIVE_INFINITY;
    }
}
